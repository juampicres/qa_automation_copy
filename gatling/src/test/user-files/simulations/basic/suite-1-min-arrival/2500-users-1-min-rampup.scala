...
class ENT_91_2 extends Simulation {
    ...
    val scenario1 = scenario("2000 users during 5 minutes")
        .exec(
            http("Sign In")
    ...
    //Setup 2500 users during 5 minutes
    setUp(
        scenario1.inject(rampUsers(2500).during(1.minutes))
