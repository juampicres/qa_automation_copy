...
class ScenarioLimit_92 extends Simulation {
    ...
    val scenario1 = scenario("Users signin in and creating a new engagement")
        .exec(
            http("Sign In")
    ...
    setUp(
        scenario1.inject(rampUsers(600).during(1.minutes))
